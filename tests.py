...
class TestRPNCalculator(unittest.TestCase):
    ...
    def test_pi_e_rand(self):
        self.setUp()
        self.assertAlmostEqual(rpn_calc.evaluate_rpn(['pi'])[0], 3.141592653589793)
        self.setUp()
        self.assertAlmostEqual(rpn_calc.evaluate_rpn(['e'])[0], 2.718281828459045)
    ...
    def test_fp(self):
        self.setUp()
        self.assertAlmostEqual(rpn_calc.evaluate_rpn([3.2, 'fp'])[0], 0.2)
        self.setUp()
        self.assertAlmostEqual(rpn_calc.evaluate_rpn([3.7, 'fp'])[0], 0.7)
